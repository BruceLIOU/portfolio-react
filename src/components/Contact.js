    ...
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22988.432496206628!2d4.247353768369119!3d43.92720576321408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12b430db4775c8c7%3A0x4078821166b44d0!2s30190%20La%20Calmette!5e0!3m2!1sfr!2sfr!4v1660119579343!5m2!1sfr!2sfr"
            width="100%"
            height="100%"
            title="map"
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">30190 La Calmette</p>
            </div>
